$(document).ready(function () {
    ...
    $(document).on("click", "#submitLoanCategoryModal", function () {
        ...
        if(category_creation_name!=""){
            $.ajax({
                url: 'categoryFile/ajaxInsertCategory.php',
                type: 'POST',
    ...
    function resetloancategoryTable(){
        $.ajax({
            url: 'categoryFile/ajaxResetCategoryTable.php',
            type: 'POST',
            data: {},
            cache: false,
    ...
    $("body").on("click","#edit_category",function(){
        ...
        $.ajax({
                url: 'categoryFile/ajaxEditCategory.php',
                type: 'POST',
    ...
    $("body").on("click","#delete_category", function(){
        ...
        if(isok==false){
            ...
            $.ajax({
                url: 'categoryFile/ajaxDeleteCategory.php',
                type: 'POST',
                data: {"category_creation_id":category_creation_id},
                cache: false,
                success:function(response){
...
function DropDownCourse(){
    $.ajax({
        url: 'categoryFile/ajaxGetCategory.php',
        type: 'post',
        data: {},
        dataType: 'json',
        success:function(response){
