...
//   { id: 'assistant', pid: 1, name: "Dean Hunter", role: "Assistant", tags: ['assistant'], img: "https://cdn.balkan.app/shared/a/19.jpg" },
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            chart.load([
                ...
                { id: response.userfullname, role: ["top-management"] },

                
                // Contents for Director name and Company name branch name above Director
                { id: 1, name: response.userfullname , role: "Director" },
