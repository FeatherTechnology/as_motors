                    ...
                    $.ajax({
                        ...
                        success: function(data){
                            ...
                            for(var a=0; a<=data.length-1; a++){
                             ...
                             var option1 = $('<option></option>').val(data[a]['department_id']).text(data[a]['department_name']);
                             $('#dept').append(option1);

                             var option2 = $('<option></option>').val(data[a]['designation_id']).text(data[a]['designation_name']);
