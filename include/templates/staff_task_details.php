...
<div class="page-header">
    <ol class="breadcrumb">
        <li class="breadcrumb-item">AS - Staff Task Details </li>
    </ol>
</div>
<!-- Page header end -->
...
<div class="main-container">
    <!--form start-->
    <form id="staff_task_details" name="staff_task_details" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row ">
                                ...
                                <div class="row">
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                        <div class="form-group">
                                            <label for="task_details_type">Task Type</label>
                                                <select tabindex="1" type="text" class="form-control emptyTable" id="task_details_type" name="task_details_type">
                            ...
                            <!--Department Start-->
                            <div class="col-md-12" id="department_task" style="display: none;">
                                <div class="row">
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                        <div class="form-group">
                            ...
                            <!-- Designation Start -->
                            <div class="col-md-12" id="designation_task" style="display: none;">
                                <div class="row">
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                        <div class="form-group">
                            ...
                            <!--Task View Button Start -->
                            <div class="col-12">
                                <div class="form-group text-right">
                                    <span class="required validate" style="display: none;">*Please Fill All the Field</span>
                                    <button type="button" tabindex="10" class="btn btn-primary" id="view_task" name="view_task" >View Task</button>
                                </div>
                            </div>
                            <!--Task View Button End -->

                        </div>
                    </div>

                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card-body table-responsive" id="task_details_view_table">
                        </div>
                    </div>
