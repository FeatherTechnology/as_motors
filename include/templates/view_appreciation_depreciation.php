        ...
        <table class="table custom-table" id="sstable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="text" class="form-control" name="achievement[]" id="achievement" placeholder="Enter new achievement" value="<?php echo $monthly_achievement[$a]; ?>" readonly></td>
                    <td>
                        <select tabindex="4" type="text" class="form-control" id="employee_rating" name="employee_rating[]" disabled>
                            <option value="">Select Employee Rating</option>  
