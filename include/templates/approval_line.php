...
$id=0;
if(isset($_POST['submitApprovalLine']) && $_POST['submitApprovalLine'] != '')
{
    ...
    <?php }
        ...
        $addApprovalLine = $userObj->addApprovalLine($mysqli,$userid);   
        ?>
...
if($del>0)
{
	...
	?>
	<script>location.href='<?php echo $HOSTPATH; ?>edit_approval_line&msc=3';</script>
    <?php	
}
...
<div class="page-header">
    <ol class="breadcrumb">
        <li class="breadcrumb-item">AS - Approval Line</li>
    </ol>

    <a href="edit_approval_line">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="text-right">
                                <button type="submit" name="submitApprovalLine" id="submitApprovalLine" class="btn btn-primary" value="Submit" tabindex="9">Submit</button>
