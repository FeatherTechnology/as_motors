...
<div class="page-header">
    <ol class="breadcrumb">
        <li class="breadcrumb-item">AS - Vehicle Diesel Slip Report </li>
    </ol>
</div>
<!-- Page header end -->
...
<div class="main-container">
    <!--form start-->
    <form id="diesel_slip_report" name="diesel_slip_report" action="" method="post" enctype="multipart/form-data">
        <!-- Row start -->
        <div class="row gutters">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                        <div class="form-group">
                                            <label for="diesel_slip_report_type">Report Type</label>
                                                <select tabindex="1" type="text" class="form-control emptyTable" id="diesel_slip_report_type" name="diesel_slip_report_type">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card-body" id="dieselSlip_report_view_table">
                        </div>
                    </div>
