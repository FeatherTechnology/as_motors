...
if (strstr($workdes_id, $ifhas)) {
    ...
    $qry = "UPDATE bm_checklist_ref set work_status = 1 where bm_checklist_ref_id = '".$maintenance_checklist_id_bm."' ";
    ...
    $qry = "UPDATE fc_insurance_renew set work_status = 1 where Fc_insurance_renew_id = '".$Fc_insurance_renew_id."' ";
