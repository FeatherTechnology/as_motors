...
$getTransferDetails=$con->query("SELECT * FROM meeting_minute_approval_line WHERE meeting_minute_approval_line_id='".strip_tags($id)."' ");
...
$approvalLineSelect = "SELECT * FROM meeting_minute_approval_line WHERE meeting_minute_approval_line_id = '".strip_tags($id)."' AND status=0 ORDER BY meeting_minute_approval_line_id DESC";
$res2 = $con->query($approvalLineSelect);
while($row2 = $res2->fetch_assoc())
{
	$meeting_minute_approval_line_id      	   = $row2['meeting_minute_approval_line_id'];
	...
	$getqry = "SELECT * FROM meeting_minutes WHERE meeting_minute_approval_line_id ='".strip_tags($meeting_minute_approval_line_id)."' and status = 0"; 
		...
		<div class="col-xl-5 col-lg-5 col-md-5 col-sm-5 col-12">
			<div class="form-group">
				<label for="inputReadOnly">List Of Attached File</label>
					...
					{ ?>
					<a href="uploads/meeting_minutes/<?php echo $meeting_minute_approval_line_id; ?>/<?php echo  $file; ?>" download><li><?php echo  $file; ?></li></a>
					<?php }?>
				</div>  
			</div>
		</div>
