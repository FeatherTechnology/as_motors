...
foreach ($result as $row) {
    ...
    $doc_no='';
    $qry3 = "SELECT * FROM meeting_minutes WHERE meeting_minutes_approval_line_id = '".$row['meeting_minutes_approval_line_id']."' AND status=0"; 
    $res3 = $con->query($qry3);
    ...
    $qry4 = "SELECT * FROM meeting_minutes_parallel_agree_disagree WHERE meeting_minutes_approval_line_id = '".$row['meeting_minutes_approval_line_id']."' AND status=0"; 
    $res4 = $con->query($qry4);
