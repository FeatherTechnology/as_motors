...
$qry = "SELECT sc.emp_code, sc.staff_name, kcr.frequency, kcr.from_date, kcr.to_date, kra.kra_category, CASE WHEN kcr.rr = 'New' THEN kcr.kpi ELSE rrr.rr END as RR
...
WHERE kc.designation = '$designation_id' && kc.status = 0 ";
