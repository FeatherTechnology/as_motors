...
$vehicle_details = $mysqli->query("SELECT cc.company_name, bc.branch_name, vd.* FROM `vehicle_details` vd LEFT JOIN branch_creation bc ON vd.company_id = bc.branch_id LEFT JOIN company_creation cc ON bc.company_id = cc.company_id");
$sno = 1;
