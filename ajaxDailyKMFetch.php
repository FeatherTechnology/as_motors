...
$query = "SELECT * FROM daily_km where 1";
    ...
    if($_POST['search']!="");
    {
        if (isset($_POST['search'])) {
            ...
            else if($_POST['search']=="Inactive")
            {
                ...
                $query .= "
                OR daily_km_id LIKE '%".$_POST['search']."%'
...
foreach ($result as $row) {
	...
	$action="<a href='daily_km&upd=$id' title='Edit details'><span class='icon-border_color'></span></a>&nbsp;&nbsp; 
	<a href='daily_km&del=$id' title='Delete details' class='delete_daily_km'><span class='icon-trash-2'></span></a>";
