...
foreach ($result as $row) {
    ...
    $doc_no='';
    $qry3 = "SELECT * FROM business_com_out WHERE business_com_line_id = '".$row['business_com_line_id']."' AND status=0"; 
    $res3 = $con->query($qry3);
    ...
    $qry4 = "SELECT * FROM business_com_parallel_agree_disagree WHERE business_com_line_id = '".$row['business_com_line_id']."' AND status=0"; 
    $res4 = $con->query($qry4);
