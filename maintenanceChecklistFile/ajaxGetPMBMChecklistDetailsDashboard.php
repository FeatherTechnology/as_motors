                        ...
                        for($o=0; $o<=sizeof($pm_checklist_id)-1; $o++){ ?>
                            <tbody>
                                <tr>
                                    ...
                                    <td><textarea disabled id="reason" name="reason[]" rows="3" cols="30" ></textarea></td>
                                </tr>
                            </tbody>
                        <?php $sno = $sno + 1; }
                    } ?>
...
<script>
    ...
    $(".pm_checklist_id").on('click', function() { 
        ...
        if (checkbox) { 
            $(this).parents('tr').find('td #reason').attr("disabled",false);
        } else { 
            $(this).parents('tr').find('td #reason').attr("disabled",true);
        }
    });
