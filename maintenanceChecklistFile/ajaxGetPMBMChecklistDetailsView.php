        ...
        <br> 
            <div style="overflow-x: auto; white-space: nowrap;" >
                ...
                while($row1 = $getPMChecklistId->fetch_assoc()){
                    ...
                    $pm_checklist_idArr[] 	= $row1["pm_checklist_id"]; //pm_checklist_multiple
                    $remarksArr[] 	= $row1["remarks"];
                    $fileArr[] 	= $row1["file"];
                    $responder_reasonArr[] 	= $row1["responder_reason"];
                }   
                        ...
                        for($o=0; $o<=sizeof($pm_checklist_id)-1; $o++){ ?>
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="uploads/maintenance_checklist/<?php echo $fileArr[$o]; ?>" download> <li><?php echo $fileArr[$o]; ?></li></a> </td>
                                    <td><textarea disabled id="reason" name="reason[]" rows="3" cols="30" > <?php echo $responder_reasonArr[$o]; ?> </textarea></td>
                                </tr>
                            </tbody>
                        <?php $sno = $sno + 1; }
                    } ?>
