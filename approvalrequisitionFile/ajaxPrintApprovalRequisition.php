...
$approvalLineSelect = "SELECT * FROM approval_line WHERE approval_line_id = '".strip_tags($id)."' AND status=0 ORDER BY approval_line_id DESC";
$res2 = $con->query($approvalLineSelect);
while($row2 = $res2->fetch_assoc())
{
	$approval_line_id      	   = $row2['approval_line_id'];
