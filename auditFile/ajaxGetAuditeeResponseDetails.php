...
<div class="card" id="stockinformation">
    <div class="card-body ">
        ...
        <div style="overflow-x: auto; white-space: nowrap;" >
            ...
            $selectDailyKMRef = $con->query("SELECT * FROM audit_assign_ref WHERE audit_assign_id = '".strip_tags($audit_assign_id)."' AND auditee_response_status = '1' ");
            while($row2 = $selectDailyKMRef->fetch_assoc()){
                ...
                $auditee_response[] 	= $row2["auditee_response"];
                $action_plan[] 	= $row2["action_plan"];
                $target_date[] 	= $row2["target_date"];
            } 
            ?>
